package com.example.advance.interceptor;

import com.example.advance.dao.LoginTicketDAO;
import com.example.advance.dao.UserDAO;
import com.example.advance.model.HostHolder;
import com.example.advance.model.LoginTicket;
...
public class TicketInterceptor implements HandlerInterceptor {
    ...
    public void postHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, ModelAndView modelAndView) {
        if (modelAndView != null && hostHolder.getUser() != null) {
            // 在渲染之前把"user"加进view里，此时在html中可以获取user
    ...
    public void afterCompletion(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, Exception e) {
        // 视图渲染完成之后，资源清理, 即清理ThreadLock中的users
        hostHolder.clear();
    }
}
